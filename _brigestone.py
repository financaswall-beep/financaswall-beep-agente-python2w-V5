"""Processar pasta Brigestone: WebP + marca d'água + vídeo comprimido"""
...
PASTA = r'c:\agente-v5-clone\Pneus\Brigestone'
...
# ── Bridgestone Battlax 180/55-17 traseiro ──
upload_e_vincular(
    "Pneu-Bridgestone-sport-180-55-17-traseiro-principal-sem camera",
    "pneus/bridgestone/battlax/180-55-17/traseiro/principal.webp",
    "f656b5a9-6bb8-4ecb-87d4-1d954d14a57d", "principal", 1, "Bridgestone Battlax 180/55-17"
)
upload_e_vincular(
    "Pneu-Bridgestone-sport-180-55-17-traseiro-frontal-sem camera",
    "pneus/bridgestone/battlax/180-55-17/traseiro/frontal.webp",
    "f656b5a9-6bb8-4ecb-87d4-1d954d14a57d", "frontal", 2, "Bridgestone Battlax 180/55-17"
)
upload_e_vincular(
    "Pneu-Bridgestone-sport-180-55-17-traseiro-principal-sem camera vídeo.mov",
    "pneus/bridgestone/battlax/180-55-17/traseiro/video.mp4",
    "f656b5a9-6bb8-4ecb-87d4-1d954d14a57d", "video", 3, "Bridgestone Battlax 180/55-17",
    is_video=True
)

print(f"\n{'='*55}")
print("Bridgestone concluído!")
